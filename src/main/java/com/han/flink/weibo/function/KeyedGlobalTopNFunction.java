 ...
 * @desc:
 */
public class KeyedGlobalTopNFunction extends ProcessWindowFunction<Tuple3<String, Integer, Long>, Tuple3<String, Integer, Long>, Integer, TimeWindow> {

    private static final Logger logger = LoggerFactory.getLogger(KeyedGlobalTopNFunction.class);

    private int topNSize;

    public KeyedGlobalTopNFunction(int topNSize) {
    ...
    @Override
    public void process(Integer integer, Context context, Iterable<Tuple3<String, Integer, Long>> elements, Collector<Tuple3<String, Integer, Long>> out) throws Exception {
